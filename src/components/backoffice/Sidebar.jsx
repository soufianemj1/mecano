  ...
  return (
    ...
    <div className="flex flex-col w-16 min-h-screen border-r dark:bg-gray-800 dark:border-gray-600">
        ...
        <div className="flex flex-col justify-between flex-1 bg-gray-700 px-3 py-10 w-16">
            <nav>
                <NavLink to={'/admin'} className={ ({ isActive }) => isActive ? "flex items-center text-indigo-600 bg-gray-50 rounded-md justify-center h-11 my-4":"flex items-center text-gray-50 rounded-md hover:bg-gray-50 hover:text-indigo-700 rounded-md justify-center h-11 my-4"} >
                ...
                <NavLink to={'/login'} className={ ({ isActive }) => isActive ? "flex items-center text-indigo-600 bg-gray-50 rounded-md justify-center h-11 my-4":"flex items-center text-gray-50 rounded-md hover:bg-gray-50 hover:text-indigo-700 rounded-md justify-center h-11 my-4"} >
